    ...
    <>
      <div className="bg-[#EE076814] w-[calc(100%_-_32px)] sm:w-[calc(100%_-_64px)] md:w-[calc(100%_-_120px)] max-w-6xl mx-auto rounded-xl md:rounded-[2.5rem] py-11 px-4 sm:px-8 md:px-11 my-10">
        ...
        <form
          ref={formRef}
          onSubmit={sendEmail}
          className="mt-4 md:mt-10 gap-0 md:gap-4 w-full max-w-lg md:max-w-2xl lg:max-w-4xl mx-auto"
        >
          ...
          <div className="flex flex-col mb-6 gap-1">
            ...
            <textarea
              ...
              className="w-full h-40 rounded-lg bg-white shadow border border-primary outline-none ring-1 ring-transparent focus:ring-primary px-4 py-3"
            />
          </div>
